    ...
    <div className="relative h-[450px] w-96 drop-shadow-2xl translate-y-12">
      ...
      >
        <svg viewBox="0 0 160 200" className="w-full h-full drop-shadow-lg" preserveAspectRatio="xMidYMin slice">
          ...
          <ellipse cx="80" cy="52" rx="20" ry="26" fill="#D2B48C" stroke="#B89B7E" strokeWidth="0.5" />
          
          {/* Cabelo Adulto Profissional */}
          <path d="M58 35 Q80 22 102 35 L106 45 Q80 38 54 45 Z" fill="#2C1810" />
          
          {/* Rosto Sóbrio */}
          <g className="opacity-90">
            <ellipse cx="72" cy="55" rx="1.8" ry="2.2" fill="#1A1A1A" />
            <ellipse cx="88" cy="55" rx="1.8" ry="2.2" fill="#1A1A1A" />
            <path d="M75 67 Q80 69 85 67" fill="none" stroke="#8B4513" strokeWidth="1.2" strokeLinecap="round" />
            {/* Sobrancelhas sutis */}
            <path d="M68 41 Q72 38 75 40" fill="none" stroke="#2C1810" strokeWidth="1" opacity="0.6" />
            <path d="M85 40 Q88 38 92 41" fill="none" stroke="#2C1810" strokeWidth="1" opacity="0.6" />
          </g>
