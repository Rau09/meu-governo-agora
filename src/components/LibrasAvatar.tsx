    ...
    <div className="relative h-[450px] w-96 drop-shadow-2xl translate-y-12">
      ...
      >
        <svg viewBox="0 0 160 200" className="w-full h-full drop-shadow-lg" preserveAspectRatio="xMidYMin slice">
          ...
          <ellipse cx="80" cy="62" rx="20" ry="26" fill="#D2B48C" stroke="#B89B7E" strokeWidth="0.5" />
          
          {/* Cabelo Adulto Profissional */}
          <path d="M58 38 Q80 25 102 38 L106 50 Q80 40 54 50 Z" fill="#2C1810" />
          
          {/* Rosto Sóbrio */}
          <g className="opacity-90">
            <ellipse cx="72" cy="65" rx="1.8" ry="2.2" fill="#1A1A1A" />
            <ellipse cx="88" cy="65" rx="1.8" ry="2.2" fill="#1A1A1A" />
            <path d="M75 77 Q80 79 85 77" fill="none" stroke="#8B4513" strokeWidth="1.2" strokeLinecap="round" />
            {/* Sobrancelhas sutis */}
