      ...
      >
        <svg viewBox="0 0 160 200" className="w-full h-full drop-shadow-lg" preserveAspectRatio="xMidYMin slice">
          ...
          <g className="opacity-90">
            ...
            {/* Sobrancelhas sutis */}
            <path d="M63 45 Q68 42 73 44" fill="none" stroke="#2C1810" strokeWidth="1.2" opacity="0.6" />
            <path d="M87 44 Q92 42 97 45" fill="none" stroke="#2C1810" strokeWidth="1.2" opacity="0.6" />
          </g>
