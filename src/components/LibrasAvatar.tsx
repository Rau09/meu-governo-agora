    ...
    <div className="relative h-[450px] w-96 drop-shadow-2xl translate-y-12">
      ...
      >
        <svg viewBox="0 0 160 200" className="w-full h-full drop-shadow-lg" preserveAspectRatio="xMidYMin slice">
          ...
          <ellipse cx="80" cy="50" rx="26" ry="30" fill="#D2B48C" stroke="#B89B7E" strokeWidth="0.5" />
          
          {/* Cabelo Adulto Profissional */}
          <path d="M52 40 Q80 15 108 40 L112 55 Q80 45 48 55 Z" fill="#2C1810" />
          
          {/* Rosto Sóbrio */}
          <g className="opacity-90">
            <ellipse cx="68" cy="52" rx="2" ry="2.5" fill="#1A1A1A" />
            <ellipse cx="92" cy="52" rx="2" ry="2.5" fill="#1A1A1A" />
