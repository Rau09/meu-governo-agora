    ...
    <div className="relative h-[450px] w-96 drop-shadow-2xl translate-y-12">
      ...
      >
        <svg viewBox="0 0 160 200" className="w-full h-full drop-shadow-lg" preserveAspectRatio="xMidYMin slice">
          ...
          <ellipse cx="80" cy="58" rx="24" ry="34" fill="#D2B48C" stroke="#B89B7E" strokeWidth="0.5" />
          
          {/* Cabelo Adulto Profissional */}
          <path d="M52 40 Q80 22 108 40 L112 55 Q80 50 48 55 Z" fill="#2C1810" />
          
          {/* Rosto Sóbrio */}
          <g className="opacity-90">
            <ellipse cx="69" cy="62" rx="2" ry="2.5" fill="#1A1A1A" />
            <ellipse cx="91" cy="62" rx="2" ry="2.5" fill="#1A1A1A" />
            <path d="M74 74 Q80 76 86 74" fill="none" stroke="#8B4513" strokeWidth="1.5" strokeLinecap="round" />
            {/* Sobrancelhas sutis */}
            <path d="M64 48 Q69 45 74 47" fill="none" stroke="#2C1810" strokeWidth="1.2" opacity="0.6" />
            <path d="M86 47 Q91 45 96 48" fill="none" stroke="#2C1810" strokeWidth="1.2" opacity="0.6" />
          </g>
